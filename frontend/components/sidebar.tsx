...
import { LayoutDashboard, Briefcase, CreditCard, User, LogOut, Menu, X, Zap } from "lucide-react";
...
export function Sidebar() {
    ...
    const navItems = allNavItems.filter((item) => !item.featureFlag || escrowEnabled);
