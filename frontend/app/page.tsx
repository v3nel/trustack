...
export default async function LandingPage() {
    ...
    const features = allFeatures.filter((f) => !(`featureFlag` in f) || escrowEnabled);
                ...
                <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mt-6 text-lg text-muted-foreground md:text-xl">
                            Manage projects, track progress, and build client trust — all in one
                            place. Trustack gives freelancers the tools to deliver transparently and
                            get paid securely.
                        </p>
                ...
                <Card className="bg-primary text-primary-foreground">
                    <CardContent className="flex flex-col items-center gap-6 py-12 text-center">
                        ...
                        <p className="max-w-xl text-primary-foreground/80">
                            Join thousands of freelancers who trust Trustack to manage projects,
                            communicate with clients, and secure payments.
                        </p>
