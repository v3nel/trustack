                ...
                <div className="relative hidden flex-col justify-between overflow-hidden bg-primary p-10 text-primary-foreground lg:flex">
                    ...
                    <div className="relative z-10">
                        <Link href="/" className="flex items-center gap-2.5">
                            ...
                            <span className="text-2xl font-bold tracking-tight">Trustack</span>
                        </Link>
                    </div>
                    ...
                    <div className="relative z-10">
                        <blockquote className="rounded-lg border border-primary-foreground/10 bg-primary-foreground/5 p-5">
                            <p className="text-sm italic text-primary-foreground/80">
                                &ldquo;Trustack changed how I work with clients. The transparency
                                and escrow system gave them peace of mind, and I get paid
                                faster.&rdquo;
                            </p>
