...
export default function PaymentsPage() {
        ...
        return (
            <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                    The Escrow &amp; Payments feature is currently disabled. Please contact your
    ...
    const totalBudget = mockProjects.reduce((sum, p) => sum + getProjectTotalBudget(p), 0);
    const totalPaid = mockProjects.reduce((sum, p) => sum + getProjectPaidAmount(p), 0);
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Payments & Escrow</h1>
