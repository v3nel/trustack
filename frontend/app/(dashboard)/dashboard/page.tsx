...
import { Plus, CheckCircle2, Clock, DollarSign, ArrowRight, CalendarDays } from "lucide-react";
import {
    mockProjects,
    getProjectProgress,
...
export default function DashboardPage() {
    ...
    const totalEarned = mockProjects.reduce((sum, p) => sum + getProjectPaidAmount(p), 0);
