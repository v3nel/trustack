    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between text-xs text-muted-foreground">
          <span
            className={step >= 1 ? "font-medium text-foreground" : ""}
          >
            Project Details
          </span>
          <span
            className={step >= 2 ? "font-medium text-foreground" : ""}
          >
            Client Info
          </span>
          <span
            className={step >= 3 ? "font-medium text-foreground" : ""}
          >
            Tasks & Share
          </span>
        </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Share this link with {clientName || "your client"} for
                        read-only access.
                      </p>
                    </div>
                  </div>
